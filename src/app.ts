...
class App {
  ...
  bindDialogToElement<T extends MediaSectionInput | TextSectionInput>(selector: string, inputComponenet: InputComponentConstructor<T>, makeSection: (input: T) => Component) {
